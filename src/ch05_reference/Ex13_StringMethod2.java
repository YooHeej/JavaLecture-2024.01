...
public class Ex13_StringMethod2 {
	...
	public static void main(String[] args) {
		...
		/* 문자열 대치 (replace) */
		String str3 = str2.replace("안년하세요", "안녕").replace("반갑습니다", "방가");
		System.out.println(str3); 						// 안녕? 방가
		System.out.println(str3.replace("방가", "Hi"));
		// 정규 표현식 사용 가능
		String regExp = str2.replaceAll("[?.]", "*");	// ? 또는. 을 *로 변경하라
